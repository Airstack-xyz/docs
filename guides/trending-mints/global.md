...
cron.schedule("0 * * * *", () => {
  ...
  const message = `${token?.name} have been minted more than ${score} times the last ${interval} minutes`;
...
🎉 :partying_face: Congratulations you've just integrated trending mints feature into your application!
