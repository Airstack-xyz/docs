...
As [Airstack](https://airstack.xyz) is a GraphQL API, it inherits this feature that enables you to call multiple API in one request, which is particularly useful for building cross-chain queries:
