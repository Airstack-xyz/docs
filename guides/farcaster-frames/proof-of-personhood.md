...
* [Check If Farcaster User Has Any Non-Virtual POAPs](proof-of-personhood.md#check-if-farcaster-user-has-any-non-virtual-poaps)
* [Check If Farcaster User Has Certain POAP(s)](proof-of-personhood.md#check-if-farcaster-user-has-certain-poap-s)
* [Check If Farcaster User Has X or More Followers on Farcaster](proof-of-personhood.md#check-if-farcaster-user-has-x-or-more-followers-on-farcaster)
* [Check If Farcaster User Is Followed By Certain High Profile Users](proof-of-personhood.md#check-if-farcaster-user-is-followed-by-certain-high-profile-users)
* [Check If Farcaster User Hold Any High Value NFTs](proof-of-personhood.md#check-if-farcaster-user-hold-any-high-value-nfts)
