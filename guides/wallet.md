...
You can use [`Wallet`](../api-references/api-reference/wallet-api.md) API to fetch all user's token (ERC20/721/1155) balances across Ethereum, Base, Degen Chain, and other [Airstack-supported chains](overview.md#supported-chains):
...
You can use [`Wallet`](../api-references/api-reference/wallet-api.md) API to fetch all user's token (ERC20/721/1155) transfers across Ethereum, Base, Degen Chain, and other [Airstack-supported chains](overview.md#supported-chains):
