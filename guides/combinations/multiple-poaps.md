...
With [nested queries](../../api-references/overview/nested-queries.md), Airstack finds the intersection of common holders of multiple POAPs in the following order:
