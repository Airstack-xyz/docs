...
With [nested queries](../../api-references/overview/nested-queries.md), Airstack finds the intersection of common holders of various ERC20s, NFTs, and POAPs in the following order:
