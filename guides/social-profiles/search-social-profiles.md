---
description: >-
  Learn how to use Airstack to search for social profiles on Farcaster that
  fulfills the given regex patterns, filters or sort variables the API offered.
layout:
  title:
    visible: true
  description:
...
[Airstack](https://airstack.xyz) provides easy-to-use [Socials](../../api-references/api-reference/socials-api.md) API for searching social profiles on Farcaster easily by using RegEx patterns.
...
If you have any questions or need help regarding searching for social profiles on Farcaster, please join our Airstack's [Telegram](https://t.me/+1k3c2FR7z51mNDRh) group.
