...
Using the GraphQL response, you can filter out and aggregate the ERC20 tokens across Ethereum, Base, Zora, and other [Airstack-supported chains](overview.md#supported-chains) by providing the response as to the `data` input of the `filterSpamERC20Tokens` function:
...
You can use [Airstack](https://airstack.xyz) to fetch all existing non-spam ERC20 tokens across Ethereum, Base, Zora, and other [Airstack-supported chains](overview.md#supported-chains):
